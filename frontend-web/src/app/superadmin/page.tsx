        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { action: "New school added", time: "2 hours ago", user: "Admin" },
                { action: "Principal invitation sent", time: "5 hours ago", user: "System" },
                { action: "School details updated", time: "Yesterday", user: "Admin" },
                { action: "New admin registered", time: "2 days ago", user: "System" },
              ].map((activity, i) => (
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className={`w-3 h-3 rounded-full mr-3 ${service.status === "Operational" ? "bg-green-500" : "bg-red-500"}`}></div>
                    <p className="text-sm font-medium">{service.name}</p>
                  </div>
                  <div className="flex items-center">
                    <p className="text-xs text-muted-foreground mr-2">{service.status}</p>
